                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image_block_one">
                        <div data-animation-box class="image-box p_relative d_block mr_30 pb_100 pt_130">
                            ...
                            <figure data-animation-text class="overlay-anim-black-bg image image-1 p_relative d_block b_radius_10" data-animation="overlay-animation"><img src="assets/images/resource/about-1.jpg" alt="Landscape Design"></figure>
                    ...
                    <div class="content_block_one">
                        <div class="content-box p_relative d_block ml_30">
                            <div class="sec-title p_relative d_block mb_20">
                                ...
                                <h2 class="p_relative d_block fs_40 fw_bold mb_0">Crafting Nature's Beauty</h2>
                            </div>
                            <div class="text p_relative d_block mb_25 wow fadeInUp" data-wow-duration="1500ms">
                                <p>At Sandscape Architects, we transform outdoor spaces into breathtaking landscapes. Our team of experts combines creativity with sustainability to deliver designs that enhance the natural beauty of your environment.</p>
                            </div>
                            <ul class="list-style-one clearfix p_relative d_block mb_30 wow fadeInUp" data-wow-duration="1500ms">
                                <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35 mb_13">Client-Centric Approach</li>
                                <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35 mb_13">Innovative Design Solutions</li>
                                <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35 mb_13">Sustainable Practices</li>
                                <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35 mb_13">Expert Team</li>
                                <li class="p_relative d_block fs_16 lh_25 fw_sbold pull-left pl_35">Unique Ideas & Solutions</li>
                            </ul>
...
<section class="service-one p_relative sec-pad">
    ...
    <div class="auto-container">
        <div class="sec-title p_relative d_block mb_50 text-center">
            <span class="sub-title p_relative d_iblock fs_15 fw_medium g_color mb_19">OUR SERVICES</span>
            <h2 class="p_relative d_block fs_40 fw_bold mb_30">Comprehensive Business Solutions</h2>
            <p class="d_block fs_18">We offer tailored solutions to meet your business needs, ensuring efficiency and growth. <br />Our team is dedicated to providing innovative strategies and exceptional service.</p>
        </div>
        <div class="row clearfix">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                <div class="service-block-one wow slideInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                        <div class="icon-box p_relative d_iblock mb_30">
                            <div class="icon p_relative d_iblock fs_50 g_color tran_5"><i class="icon-16"></i></div>
                            <div class="icon-img hidden-icon"><img src="assets/images/icons/hid-icon-7.png" alt=""></div>
                            <div class="icon-shape hero-shape-four p_absolute w_90 h_70"></div>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                <div class="service-block-one wow slideInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                        <div class="icon-box p_relative d_iblock mb_30">
                            <div class="icon p_relative d_iblock fs_50 g_color tran_5"><i class="icon-17"></i></div>
                            <div class="icon-img hidden-icon"><img src="assets/images/icons/hid-icon-8.png" alt=""></div>
                            <div class="icon-shape hero-shape-four p_absolute w_90 h_70"></div>
                        </div>
        ...
        <div class="row clearfix mt_50">
            <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                <div class="service-block-one wow slideInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                        <div class="icon-box p_relative d_iblock mb_30">
                            <div class="icon p_relative d_iblock fs_50 g_color tran_5"><i class="icon-18"></i></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                <div class="service-block-one wow slideInUp animated" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                        <div class="icon-box p_relative d_iblock mb_30">
                            <div class="icon p_relative d_iblock fs_50 g_color tran_5"><i class="icon-20"></i></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 service-block">
                <div class="service-block-one wow slideInUp animated" data-wow-delay="1000ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block pl_40 pt_50 pr_30 pb_35 b_radius_10 tran_5">
                        <div class="icon-box p_relative d_iblock mb_30">
                            <div class="icon p_relative d_iblock fs_50 g_color tran_5"><i class="icon-21"></i></div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content_block_two">
                        <div class="content-box p_relative d_block mr_130 z_1">
                            <div class="sec-title p_relative d_block mb_20">
                                <span class="sub-title p_relative d_iblock fs_15 fw_medium g_color mb_19">CHOOSE Sandscape Architects</span>
                                <h2 class="p_relative d_block fs_40 fw_bold mb_0">Why Choose Us</h2>
                            </div>
                            <div class="text p_relative d_block mb_25 wow fadeInUp" data-wow-duration="1500ms">
                                <p class="fs_18">Innovative & Bespoke Designs: We craft unique, creative and personalized landscapes that seamlessly combine functionality, aesthetics and your specific vision.</p>
                            </div>
                            <div class="inner-box p_relative d_block wow fadeInUp" data-wow-duration="1500ms">
                                <div class="single-item p_relative d_block pl_80 mb_16">
                                    ...
                                    <h4 class="d_block fs_20 lh_30 mb_4">Sustainability at the Core</h4>
                                    <p class="mb_0">Our eco-conscious approach integrates sustainable practices to ensure landscapes are environmentally responsible, resilient and enduring.</p>
                                </div>
                                <div class="single-item p_relative d_block pl_80 mb_16">
                                    <div class="icon-box p_absolute l_0 t_3 w_50 h_50 lh_50 text-center b_radius_50 b_shadow_7">
                                        <div class="icon p_relative d_iblock g_color"><i class="icon-15"></i></div>
                                    ...
                                    <h4 class="d_block fs_20 lh_30 mb_4">Expertise in Challenging Climates</h4>
                                    <p class="mb_0">With deep knowledge of the Gulf region’s environment, we specialize in designing landscapes that thrive even in harsh and arid climates.</p>
                                </div>
                                <div class="single-item p_relative d_block pl_80">
                                    ...
                                    <h4 class="d_block fs_20 lh_30 mb_4">Exceptional Value at Low Cost</h4>
                                    <p class="mb_0">We offer high-quality, innovative designs while maintaining cost-efficiency, ensuring you get the best value for your investment without compromising on excellence.</p>
                                </div>
...
<section class="process-one p_relative sec-pad text-center bg-color-1">
    ...
    <div class="auto-container">
        <div class="sec-title p_relative d_block mb_60">
            ...
            <h2 class="p_relative d_block fs_40 fw_bold mb_30">Our Proven Process</h2>
            <p>We follow a structured approach to ensure the success of every project. Here's how we do it:</p>
        </div>
        <div class="row clearfix">
            <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                <div class="processing-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block">
                        ...
                        <h4 class="d_block fs_20 lh_30 mb_15">Plan & Schedule</h4>
                        <p>We begin by understanding your needs and creating a detailed plan and schedule to meet your goals.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                <div class="processing-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block">
                        ...
                        <h4 class="d_block fs_20 lh_30 mb_15">Collaborate & Discuss</h4>
                        <p>Engage in open discussions to refine ideas and ensure alignment with your vision.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                <div class="processing-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block">
                        ...
                        <h4 class="d_block fs_20 lh_30 mb_15">Execute & Deliver</h4>
                        <p>Implement the plan with precision and deliver results that exceed expectations.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center clearfix">
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image_block_three">
                        <div data-animation-box class="image-box p_relative d_block mr_30 pr_190 pt_90">
                            ...
                            <figure data-animation-text class="overlay-anim-black-bg image image-2 p_absolute t_0 r_0 b_radius_10" data-animation="overlay-animation"><img src="assets/images/resource/skills-2.jpg" alt="Landscape Design"></figure>
                            <figure data-animation-text class="overlay-anim-black-bg image image-1 p_relative d_block b_radius_10" data-animation="overlay-animation"><img src="assets/images/resource/skills-1.jpg" alt="Landscape Design"></figure>
                            <div class="text p_absolute r_30 b_30 pt_25 pr_70 pl_30 pb_25 z_1">
                                <h4 class="p_relative d_block fs_20 lh_30 mb_0">Innovative Landscape Solutions Since 2020.</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div class="content_block_three">
                        <div class="content-box p_relative d_block ml_30">
                            <div class="sec-title p_relative d_block mb_20">
                                <span class="sub-title p_relative d_iblock fs_15 fw_medium g_color mb_19">Our Expertise</span>
                                <h2 class="p_relative d_block fs_40 fw_bold mb_30">Transforming Spaces with Nature's Beauty</h2>
                            </div>
                            <div class="text p_relative d_block mb_30 wow fadeInUp" data-wow-duration="1500ms">
                                <p>We specialize in creating stunning landscapes that blend aesthetics with functionality. Our team is dedicated to crafting outdoor spaces that reflect your vision and enhance the natural beauty of your environment.</p>
                            </div>
                            <div class="progress-inner p_relative d_block wow fadeInUp" data-wow-duration="1500ms">
                                <div class="progress-box p_relative d_block mb_35">
                                    <h6 class="d_block fs_16 lh_20 mb_7">Design & Planning</h6>
                                    <div class="bar">
                                ...
                                <div class="progress-box p_relative d_block mb_35">
                                    <h6 class="d_block fs_16 lh_20 mb_7">Sustainability</h6>
                                    <div class="bar">
                                        <div class="bar-inner count-bar" data-percent="85%"></div>
                                        <div class="count-text p_absolute r_0 b_10 fs_16">85%</div>
                                    </div>
                                </div>
                                <div class="progress-box p_relative d_block">
                                    <h6 class="d_block fs_16 lh_20 mb_7">Execution & Maintenance</h6>
                                    <div class="bar">
    ...
    <div class="auto-container">
        <div class="inner-container p_relative pt_150 pb_140">
            ...
            <div class="sec-title p_relative d_block mb_60 text-center z_1">
                ...
                <h2 class="p_relative d_block fs_40 fw_bold mb_30">Trusted by Landscape Enthusiasts <br />Worldwide</h2>
                <p>Our clients love the transformation of their outdoor spaces. <br />Here's what they have to say:</p>
            </div>
                ...
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>The landscape design transformed our backyard into a serene oasis. The team was professional and attentive to our needs.</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-1.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Alex Johnson</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Homeowner</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>Our garden has never looked better! The attention to detail and creativity exceeded our expectations.</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-2.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Nicolas Lawson</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Garden Enthusiast</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>The landscape architects brought our vision to life with their innovative designs and sustainable practices.</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-3.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Keanu Reeves</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Landscape Lover</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>Thanks to the team, our outdoor space is now a perfect blend of beauty and functionality.</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-4.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Emma Watson</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Nature Enthusiast</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>Their expertise in sustainable landscaping is unmatched. Our garden is thriving!</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-5.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Liam Neeson</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Eco Advocate</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>Our landscape project was completed on time and within budget. Highly recommend!</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-6.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Sophia Turner</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Project Manager</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>The design team was fantastic, and the results speak for themselves. Our garden is stunning!</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-7.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Chris Evans</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Landscape Designer</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>We are thrilled with our new outdoor space. The team was knowledgeable and efficient.</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-8.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Jessica Alba</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Outdoor Enthusiast</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial-block-one">
                    <div class="inner-box p_relative d_block">
                        <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                            ...
                            <p>The transformation of our landscape was beyond our expectations. Highly skilled team!</p>
                        </div>
                        <div class="author p_relative d_block pl_90 pt_7 pb_11 ml_20">
                            <figure class="thumb-box p_absolute l_0 t_0 w_70 h_70 b_radius_50"><img src="assets/images/resource/testimonial-landscape-9.png" alt="Client Image"></figure>
                            <h4 class="d_block fs_20 lh_30 mb_2">Robert Downey Jr.</h4>
                            <span class="designation p_relative d_block fs_16 lh_20">Landscape Enthusiast</span>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- funfact-one -->
<section class="funfact-one pt_90 pb_80 text-center p_relative mb_100">
                ...
                <div class="counter-block-one wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block">
                        <div class="count-outer count-box p_relative d_block fs_70 lh_70 g_color fw_bold mb_17">
                            <span class="count-text" data-speed="2500" data-stop="150">150</span>
                        </div>
                        <p class="p_relative d_block fs_16 lh_20 fw_medium color_white">Designs</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12 funfact-block">
                <div class="counter-block-one wow slideInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block">
                        <div class="count-outer count-box p_relative d_block fs_70 lh_70 g_color fw_bold mb_17">
                            <span class="count-text" data-speed="2500" data-stop="140">140</span>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 funfact-block">
                <div class="counter-block-one wow slideInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="inner-box p_relative d_block">
                        ...
                        <p class="p_relative d_block fs_16 lh_20 fw_medium color_white">Years of Experience</p>
                    </div>
                </div>
            </div>
