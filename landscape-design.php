...
<section class="about-three p_relative sec-pad">
    <div class="shape parallax-scene parallax-scene-1">
        <div data-depth="0.50" class="shape-1 p_absolute w_170 h_170 l_0"></div>
        <div data-depth="0.30" class="shape-2 p_absolute t_0" style="background-image: url(assets/images/shape/shape-55.png);"></div>
        <div data-depth="0.30" class="shape-3 p_absolute t_0" style="background-image: url(assets/images/shape/shape-56.png);"></div>
        <div data-depth="0.50" class="shape-4 p_absolute w_170 h_170 l_0"></div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 processing-block">
                <div class="processing-block-four">
                    <div class="inner-box p_relative d_block pl_30 pr_30">
                        <div class="line-shape p_absolute tran_5 t_20" style="background-image: url(assets/images/shape/shape-178.png);"></div>
                        <div class="count-box p_relative d_iblock w_70 h_70 lh_70 centred b_radius_50 fs_18 fw_sbold font_family_inter z_1 tran_5 mb_80">
    ...
    <div class="auto-container">
        <div class="sortable-masonry">
            <div class="items-container row clearfix">
                <div class="col-lg-6 col-md-6 col-sm-12 testimonial-block masonry-item small-column">
                    <div class="testimonial-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 testimonial-block masonry-item small-column">
                    <div class="testimonial-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box p_relative d_block mb_50">
                            <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                                <ul class="rating clearfix p_relative d_block mb_15">
                                    <li class="p_relative d_iblock pull-left fs_16 mr_5"><i class="icon-20"></i></li>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 testimonial-block masonry-item small-column">
                    <div class="testimonial-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box p_relative d_block mb_50">
                            <div class="text p_relative d_block b_radius_10 pt_35 pr_40 pb_40 pl_40 mb_30">
                                <ul class="rating clearfix p_relative d_block mb_15">
                                    <li class="p_relative d_iblock pull-left fs_16 mr_5"><i class="icon-20"></i></li>
