...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!-- service-18 -->
        <section class="service-18 p_relative pt_150 pb_120 centred">
            <div class="auto-container">
                <div class="row clearfix">
                    <!-- Landscape Design & Planning -->
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-14 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_35 pt_50 pr_35 pb_35 b_radius_10 tran_5 b_shadow_6 mb_30">
                                <div class="icon-box p_relative d_iblock mb_35">
                                    <div class="icon p_relative d_iblock fs_45 g_color tran_5"><i class="icon-11"></i></div>
                    ...
                    <!-- Hardscaping -->
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-14 wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_35 pt_50 pr_35 pb_35 b_radius_10 tran_5 b_shadow_6 mb_30">
                                <div class="icon-box p_relative d_iblock mb_35">
                                    <div class="icon p_relative d_iblock fs_45 g_color tran_5"><i class="icon-12"></i></div>
                    ...
                    <!-- Softscaping -->
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-14 wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_35 pt_50 pr_35 pb_35 b_radius_10 tran_5 b_shadow_6 mb_30">
                                <div class="icon-box p_relative d_iblock mb_35">
                                    <div class="icon p_relative d_iblock fs_45 g_color tran_5"><i class="icon-13"></i></div>
                    ...
                    <!-- Lighting Design -->
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-14 wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_35 pt_50 pr_35 pb_35 b_radius_10 tran_5 b_shadow_6 mb_30">
                                <div class="icon-box p_relative d_iblock mb_35">
                                    <div class="icon p_relative d_iblock fs_45 g_color tran_5"><i class="icon-14"></i></div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-14 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_35 pt_50 pr_35 pb_35 b_radius_10 tran_5 b_shadow_6 mb_30">
                                <div class="icon-box p_relative d_iblock mb_35">
                                    <div class="icon p_relative d_iblock fs_45 g_color tran_5"><i class="icon-170"></i></div>
                                    <div class="icon-img hidden-icon"><img src="assets/images/icons/hid-icon-120.png" alt=""></div>
                                    <div class="icon-shape hero-shape-four p_absolute w_90 h_70 tran_5"></div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-14 wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_35 pt_50 pr_35 pb_35 b_radius_10 tran_5 b_shadow_6 mb_30">
                                <div class="icon-box p_relative d_iblock mb_35">
                                    <div class="icon p_relative d_iblock fs_45 g_color tran_5"><i class="icon-171"></i></div>
                                    <div class="icon-img hidden-icon"><img src="assets/images/icons/hid-icon-121.png" alt=""></div>
                                    <div class="icon-shape hero-shape-four p_absolute w_90 h_70 tran_5"></div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-14 wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_35 pt_50 pr_35 pb_35 b_radius_10 tran_5 b_shadow_6 mb_30">
                                <div class="icon-box p_relative d_iblock mb_35">
                                    <div class="icon p_relative d_iblock fs_45 g_color tran_5"><i class="icon-172"></i></div>
                                    <div class="icon-img hidden-icon"><img src="assets/images/icons/hid-icon-122.png" alt=""></div>
                                    <div class="icon-shape hero-shape-four p_absolute w_90 h_70 tran_5"></div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 service-block">
                        <div class="service-block-14 wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block pl_35 pt_50 pr_35 pb_35 b_radius_10 tran_5 b_shadow_6 mb_30">
                                <div class="icon-box p_relative d_iblock mb_35">
                                    <div class="icon p_relative d_iblock fs_45 g_color tran_5"><i class="icon-173"></i></div>
                                        ...
                                        <div class="content_block_27">
                                            <div class="content-box p_relative d_block mr_30">
                                                ...
                                                <ul class="list-style-one clearfix p_relative d_block mb_35">
                                                    ...
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Project Scope Definition</li>
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Initial Conceptualization</li>
                                        ...
                                        <div class="content_block_27">
                                            <div class="content-box p_relative d_block ml_30">
                                                ...
                                                <ul class="list-style-one clearfix p_relative d_block mb_35">
                                                    ...
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Blueprint Creation</li>
                                        ...
                                        <div class="content_block_27">
                                            <div class="content-box p_relative d_block mr_30">
                                                ...
                                                <ul class="list-style-one clearfix p_relative d_block mb_35">
                                                    ...
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Interactive Presentations</li>
                                        ...
                                        <div class="content_block_27">
                                            <div class="content-box p_relative d_block ml_30">
                                                ...
                                                <ul class="list-style-one clearfix p_relative d_block mb_35">
                                                    ...
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Material and Resource Planning</li>
