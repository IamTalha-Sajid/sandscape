...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <section class="page-title p_relative centred">
            ...
            <div class="auto-container">
                <div class="content-box">
                    <h1 class="d_block fs_60 lh_70 fw_bold mb_10">Swimming Pools</h1>
                ...
                <div data-animation-box class="upper-box p_relative mb_60">
                    <div class="clearfix text-center">
                        <div class="col-lg-12 col-md-12 col-sm-12 title-column">
                            <div class="sec-title-three p_relative d_block">
                                <h3 class="d_block fs_40 fw_bold font_family_oxygen">Swimming Pool Gallery</h3> <!-- Updated title -->
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 text-column">
                            <div class="text p_relative d_block ml_30 mt_30">
                                <p class="fs_18 font_family_oxygen lh_28">Experience the serenity of our landscape pools</p> <!-- Updated text -->
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- news-two -->
        <section class="news-two p_relative pb_100 pt_20">
            <div class="auto-container">
                <div class="row clearfix">
                        ...
                        <div class="news-block-one wow slideInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block b_radius_10 b_shadow_6">
                                <div class="image-box p_relative d_block">
                                    <figure class="image p_relative d_block"><a href="resort-style.html"><img src="assets/images/pools/resort-style.jpg" alt="Resort Style Pool"></a></figure>
                                </div>
                                <div class="lower-content p_relative d_block pt_30 pr_30 pb_40 pl_40">
                                    <ul class="post-info clearfix p_relative d_block mb_5">
                                        <li class="p_relative d_iblock float_left mr_30 fs_16"><a href="resort-style.html">Resort Style</a></li>
                                        <li class="p_relative d_iblock float_left fs_16">Luxurious Experience</li>
                                    </ul>
                                    <h4 class="d_block fs_20 lh_30 mb_15"><a href="resort-style.html">Experience the Ultimate Luxury</a></h4>
                                    <p class="d_block mb_20">Our resort-style pools offer a luxurious escape with stunning designs and premium amenities.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow slideInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block b_radius_10 b_shadow_6">
                                <div class="image-box p_relative d_block">
                                    <figure class="image p_relative d_block"><a href="home-style.html"><img src="assets/images/pools/home-style.jpg" alt="Home Style Pool"></a></figure>
                                </div>
                                <div class="lower-content p_relative d_block pt_30 pr_30 pb_40 pl_40">
                                    <ul class="post-info clearfix p_relative d_block mb_5">
                                        <li class="p_relative d_iblock float_left mr_30 fs_16"><a href="home-style.html">Home Style</a></li>
                                        <li class="p_relative d_iblock float_left fs_16">Comfort & Elegance</li>
                                    </ul>
                                    <h4 class="d_block fs_20 lh_30 mb_15"><a href="home-style.html">Your Personal Oasis</a></h4>
                                    <p class="d_block mb_20">Transform your backyard into a personal oasis with our elegant home-style pools.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow slideInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box p_relative d_block b_radius_10 b_shadow_6">
                                <div class="image-box p_relative d_block">
                                    <figure class="image p_relative d_block"><a href="tropical-style.html"><img src="assets/images/pools/tropical-style.jpg" alt="Tropical Style Pool"></a></figure>
                                </div>
                                <div class="lower-content p_relative d_block pt_30 pr_30 pb_40 pl_40">
                                    <ul class="post-info clearfix p_relative d_block mb_5">
                                        <li class="p_relative d_iblock float_left mr_30 fs_16"><a href="tropical-style.html">Tropical Style</a></li>
                                        <li class="p_relative d_iblock float_left fs_16">Exotic & Refreshing</li>
                                    </ul>
                                    <h4 class="d_block fs_20 lh_30 mb_15"><a href="tropical-style.html">A Slice of Paradise</a></h4>
                                    <p class="d_block mb_20">Immerse yourself in a tropical paradise with our exotic and refreshing pool designs.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="auto-container">
                        <ul class="tab-btns tab-buttons clearfix">
                            <li class="tab-btn active-btn" data-tab="#tab-1">
                                ...
                                <h6 class="fs_16 tran_5">Strategic Consulting</h6>
                            </li>
                            <li class="tab-btn" data-tab="#tab-2">
                                <div class="icon-box p_absolute fs_30 color_black tran_5 t_25 l_50"><i class="icon-12"></i></div>
                                <h6 class="fs_16 tran_5">Financial Advice</h6>
                            </li>
                            <li class="tab-btn" data-tab="#tab-3">
                                <div class="icon-box p_absolute fs_30 color_black tran_5 t_25 l_50"><i class="icon-13"></i></div>
                                <h6 class="fs_16 tran_5">Brand Developing</h6>
                            </li>
                                        ...
                                        <div class="content_block_27">
                                            <div class="content-box p_relative d_block mr_30">
                                                <div class="sec-title-six p_relative d_block mb_25">
                                                    <h2 class="d_block fs_40 lh_50 fw_bold">Attractive</h2> <!-- Updated heading -->
                                                </div>
                                                <div class="text p_relative d_block mb_25">
                                                    <p class="font_family_poppins">Our pools are designed to captivate with stunning aesthetics and elegant finishes, making them a centerpiece of any landscape.</p> <!-- Updated content -->
                                                </div>
                                                <ul class="list-style-one clearfix p_relative d_block mb_35">
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Eye-catching designs</li>
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Customizable features</li>
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Premium materials</li>
                                                </ul>
                                                <div class="btn-box">
                                                    <a href="pool-details.html" class="theme-btn theme-btn-five">Explore More <i class="icon-4"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <div class="image_block_24">
                                            <div class="image-box p_relative d_block ml_30">
                                                <div class="shape">
                                                    <div class="shape-1 float-bob-x p_absolute w_95 h_95" style="background-image: url(assets/images/shape/shape-193.png);"></div>
                                                ...
                                                <figure class="image p_relative d_block b_radius_10"><img src="assets/images/pools/attractive-pool.jpg" alt="Attractive Pool"></figure> <!-- Updated image -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <div class="image_block_24">
                                            <div class="image-box p_relative d_block mr_30">
                                                <div class="shape">
                                                    <div class="shape-4 float-bob-x p_absolute w_95 h_95" style="background-image: url(assets/images/shape/shape-193.png);"></div>
                                                ...
                                                <figure class="image p_relative d_block b_radius_10"><img src="assets/images/pools/unique-pool.jpg" alt="Unique Pool"></figure> <!-- Updated image -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                        <div class="content_block_27">
                                            <div class="content-box p_relative d_block ml_30">
                                                <div class="sec-title-six p_relative d_block mb_25">
                                                    <h2 class="d_block fs_40 lh_50 fw_bold">Unique</h2> <!-- Updated heading -->
                                                </div>
                                                <div class="text p_relative d_block mb_25">
                                                    <p class="font_family_poppins">Each pool is uniquely crafted to reflect your personal style, offering a one-of-a-kind aquatic experience.</p> <!-- Updated content -->
                                                </div>
                                                <ul class="list-style-one clearfix p_relative d_block mb_35">
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Tailored designs</li>
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Innovative features</li>
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Exclusive styles</li>
                                                </ul>
                                                <div class="btn-box">
                                                    <a href="pool-details.html" class="theme-btn theme-btn-five">Explore More <i class="icon-4"></i></a>
                                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                        <div class="content_block_27">
                                            <div class="content-box p_relative d_block mr_30">
                                                <div class="sec-title-six p_relative d_block mb_25">
                                                    <h2 class="d_block fs_40 lh_50 fw_bold">Long Lasting</h2> <!-- Updated heading -->
                                                </div>
                                                <div class="text p_relative d_block mb_25">
                                                    <p class="font_family_poppins">Built with durability in mind, our pools are designed to withstand the test of time, providing endless enjoyment.</p> <!-- Updated content -->
                                                </div>
                                                <ul class="list-style-one clearfix p_relative d_block mb_35">
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Robust construction</li>
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">High-quality materials</li>
                                                    <li class="p_relative d_block fs_16 lh_25 fw_medium pull-left font_family_inter pl_25 mb_13">Low maintenance</li>
                                                </ul>
                                                <div class="btn-box">
                                                    <a href="pool-details.html" class="theme-btn theme-btn-five">Explore More <i class="icon-4"></i></a>
                                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <div class="image_block_24">
                                            <div class="image-box p_relative d_block ml_30">
                                                ...
                                                <figure class="image p_relative d_block b_radius_10"><img src="assets/images/pools/long-lasting-pool.jpg" alt="Long Lasting Pool"></figure> <!-- Updated image -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
